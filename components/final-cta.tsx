          ...
          <div className="rounded-2xl border bg-card px-8 py-16 sm:px-16">
            <div className="text-center space-y-6">
              <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl md:text-5xl text-foreground">
                Skip the build-from-scratch backlog. Ship the app.
              </h2>
              <p className="mx-auto max-w-2xl text-muted-foreground text-lg leading-relaxed">
                Try the live demo, clone the repo, or read the docs. Everything you need to build
                admin panels, CRMs, ERPs, and B2B portals on Supabase, open source, forever.
              </p>
