...
- **[Authorization](/guide/authorization)** — Three roles, permissions, and RLS patterns
- **[Notifications](/guide/notifications)** — Deliver notifications to specific users or roles
- **[Audit Logs](/guide/audit-logs)** — Track every change made by every user
