...
3. Add JSON metadata comment with `type: "report"`
...
values ('user', 'public.task_report:select');
```
...
- **[Dashboards](/guide/dashboards)** - Create visual dashboards
- **[Charts](/guide/charts)** - Add visualizations
- **[Authorization](/guide/authorization)** - Secure your reports
