...
- This same limitation and fix apply to [`fields.lookups`](/resource/metadata#fieldslookups) and FK dropdown relations described in [Relations](/resource/basic#relations) — anywhere Supasheet needs to embed a cross-schema table.
...
- **[Views](/resource/views)** - Configure six view types (Sheet, Kanban, Calendar, Gallery, List, Tree)
- **[Basic Resources](/resource/basic)** - Learn about CRUD interfaces
