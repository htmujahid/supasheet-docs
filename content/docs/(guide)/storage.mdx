...
See **[Data Types](/guide/resource/data-types)** for the full type reference and **[Metadata → File columns](/guide/resource/metadata#file-columns)** for the column metadata options.
...
- **[Data Types](/guide/resource/data-types)** — `FILE`, `FILE_OBJECT`, `AVATAR`, `RICH_TEXT`
- **[Metadata](/guide/resource/metadata#file-columns)** — Column-level configuration for file fields
- **[Authorization](/guide/authorization)** — How `schema.table:*` permissions gate the `uploads` bucket
