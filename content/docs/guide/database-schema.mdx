...
<Callout type="warn">
Always reference `supasheet.users(id)` instead of `auth.users(id)`. See [User Management](/guide/user-management) for the reasoning.
</Callout>
...
|------|--------------------|---------------|
| `chart` | `supasheet.get_charts(p_schema)` | [Charts](/guide/charts) |
| `dashboard_widget` | `supasheet.get_widgets(p_schema)` | [Dashboards](/guide/dashboards) |
| `report` | `supasheet.get_reports(p_schema)` | [Reports](/guide/reports) |
| `template` | `supasheet.get_templates(p_schema)` | [Templates](/guide/templates) |
...
- **[Authorization](/guide/authorization)** — Grant permissions per schema/table
- **[Resource Basics](/guide/resource/basic)** — Build CRUD on top of your tables
- **[Charts](/guide/charts)** — Build a chart from a view
- **[Reports](/guide/reports)** — Build a report from a view
- **[Templates](/guide/templates)** — Reuse preset data via templates
