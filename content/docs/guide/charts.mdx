...
For complex or slow queries. See [Materialized Views](/guide/resource/materialized-views) for how Supasheet treats these as a resource type in their own right:
...
- **[Dashboards](/guide/dashboards)** - Combine charts into dashboards
- **[Reports](/guide/reports)** - Generate detailed reports
- **[Database Schema](/guide/database-schema)** - Learn more about the charts schema
