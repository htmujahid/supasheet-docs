...
For expensive queries. See [Materialized Views](/guide/resource/materialized-views) for how Supasheet treats these as a resource type in their own right:
...
- **[Charts](/guide/charts)** - Add visualizations to your dashboards
- **[Reports](/guide/reports)** - Generate detailed reports
- **[Authorization](/guide/authorization)** - Control dashboard access
