...
- **[Metadata](/docs/guide/resource/metadata)** - Configure icons, visibility, columns, and views
- **[Query Configuration](/docs/guide/resource/query)** - Set default sorting and filters
- **[Views](/docs/guide/resource/views)** - Multiple view types (Sheet, Kanban, Calendar, Gallery, List, Tree)
