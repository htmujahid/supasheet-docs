...
- **[Audit Logs](/guide/audit-logs)** — Track rows created via templates
- **[Authorization](/guide/authorization)** — Permissions on the template view and its target
- **[Reports](/guide/reports)** — Reports follow the same `type`-tagged view pattern
