...
- **[Audit Logs](/docs/guide/audit-logs)** — Track rows created via templates
- **[Authorization](/docs/guide/authorization)** — Permissions on the template view and its target
- **[Reports](/docs/guide/reports)** — Reports follow the same `type`-tagged view pattern
