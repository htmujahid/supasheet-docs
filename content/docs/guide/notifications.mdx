...
- **[Comments](/guide/comments)** — Pair comments with comment-driven notifications
- **[Audit Logs](/guide/audit-logs)** — Notifications + audit logs gives you a clean event trail
- **[Authorization](/guide/authorization)** — Resolving recipients with `get_users_with_role` / `_with_permission`
