...
6. **Accounts** - Manage all users in the system (view, create, update, delete) if you have the required permissions: `supasheet.accounts:select`, `supasheet.accounts:insert`, `supasheet.accounts:update`, and `supasheet.accounts:delete`
