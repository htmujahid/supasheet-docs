...
- **SQL Editor** — Built-in read-only SQL editor with saved snippets
...
Follow the [installation guide](/docs/guide/installation) to get Supasheet running locally in a few minutes.
</Step>

<Step>
### Learn the SQL-First Workflow

Read the [SQL-first philosophy](/docs/guide/sql-first-philosophy) to understand how Supasheet turns a SQL schema into a complete CMS.
</Step>
</Steps>
...
<Cards>
  ...
  <Card title="Resource Basics" href="/docs/guide/resource/basic">
