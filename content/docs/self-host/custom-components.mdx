...
Supasheet's `tsconfig.json` configures both `#/*` and `@/*` as aliases for `./src/*`. The codebase consistently uses `#/...` — match that convention in your custom components so you don't fight ESLint.
