...
See **[Quickstart](/guide/quickstart)** and **[Complete Example](/guide/complete-example)** for full templates, and **[Examples in the repo](https://github.com/htmujahid/supasheet/tree/main/supabase/examples)** for 12 reference domains.
