...
See **[Environment Variables](/self-host/environment-variables)** for details.
...
- **[Environment Variables](/self-host/environment-variables)** - Full variable list
- **[Production Checklist](/self-host/production-checklist)** - Pre-launch verification
