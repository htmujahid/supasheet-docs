...
- **[Prerequisites](/self-host/prerequisites)** — System requirements
- **[Environment Variables](/self-host/environment-variables)** — All `VITE_*` variables
- **[Database Setup](/self-host/database-setup)** — Apply migrations + expose schemas
- **[Deployment](/self-host/deployment)** — Deploy to Vercel, Netlify, Cloudflare, Docker, or a VPS
- **[Production Checklist](/self-host/production-checklist)** — Pre-launch checks
