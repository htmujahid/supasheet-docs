...
- **[Custom Components](/self-host/custom-components)** - Build themed components
- **[AI Coding Agents](/self-host/ai-coding-agents)** - Build features with the bundled agent skill
